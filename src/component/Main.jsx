        ...
        <div className='image_editor'>
            <div className="card">
                <div className="card_header">
                    <h2>Editor de imagen React JS Codo a codo</h2>
                </div>
                <div className="card_body">
                    <div className="sidebar">
                        ...
                        <div className="reset">
                            ...
                            <button onClick={saveImage} className='save'>Guardar imagen</button>
                        </div>
                    </div>
                    <div className="image_section">
                        ...
                        <div className="image_select">
                            ...
                            <label htmlFor="choose">Elegir imagen</label>
